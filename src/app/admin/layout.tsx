      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <motion.aside
            ...
            className="hidden lg:flex flex-col w-72 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-r border-slate-200/50 dark:border-slate-700/50 py-6 px-4 gap-4 fixed top-16 left-0 h-[calc(100vh-4rem)] z-30"
          >
          ...
          <motion.main
            ...
            className="flex-1 bg-transparent p-4 lg:p-8 overflow-y-auto min-h-0 flex flex-col lg:ml-72"
          >
            {children}
          </motion.main>
        </div>
