      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="font-semibold text-gray-900">User Consent</h3>
              </div>
              <ul className="text-sm text-gray-700 space-y-1">
        ...
        <section className="bg-white rounded-lg shadow-sm p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="flex items-start mb-2">
                <Database className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                <h4 className="font-medium text-gray-900 text-sm">
                  Right of Access
                </h4>
              </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="flex items-start mb-2">
                <Settings className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                <h4 className="font-medium text-gray-900 text-sm">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="flex items-start mb-2">
                <RefreshCw className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                <h4 className="font-medium text-gray-900 text-sm">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <div className="flex items-start mb-2">
                <Scale className="h-4 w-4 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                <h4 className="font-medium text-gray-900 text-sm">
                  Right to Complain
                </h4>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-red-50 rounded-lg p-5 border border-red-200">
              <div className="flex items-center mb-3">
                ...
                <h3 className="font-semibold text-gray-900">Administrative</h3>
              </div>
              <ul className="text-sm text-gray-700 space-y-1">
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="space-y-2">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-green-900">Controller</p>
                      <p className="text-green-800 text-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start">
                  <Mail className="h-4 w-4 text-blue-500 mr-2 mt-0.5" />
                  <div>
        ...
        <section className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center mb-6">
            <RefreshCw className="h-6 w-6 text-purple-500 mr-3" />
            <h2 className="text-2xl font-semibold text-gray-900">
